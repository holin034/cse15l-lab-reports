...
* Just a reminder, you will need to create your own password.
* To create your personal password, you must have at least a capital letter, a lowercase letter, a number, and a special character.
...
* First, you should open a new terminal by using the terminal option in menu bar and click on open a new terminal.
...
* Next, you should type in this command in your newly created terminal:
```
ssh cs15lwi23(your account name)@ieng6.ucsd.edu
```
* Then, you will be asked a question and will need to type "yes" to answer that question. (see below)
```
...
```
* After that, you must type in your newly created password.(Type your password carefully since you won't be able to see what you've typed)
* Lastly, congrats, your terminal is connected to a computer in the lab room!
